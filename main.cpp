...
int main(int argc, char **argv) {
  ...
  while (1) {
    Background background =
        Background("/usr/share/bunnymenu/background.jpg", width, height, bpp);
    stringmap list;
    list.insert(std::make_pair("NES", "/usr/share/bunnymenu/nes.png"));
    list.insert(std::make_pair("SNES", "/usr/share/bunnymenu/snes.png"));
    list.insert(std::make_pair("GENESIS", "/usr/share/bunnymenu/genesis.png"));
